(() => {
  ...
  !(function (e) {
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: a, params: r }) {
        ...
        s("init", () => {
          ...
          s("beforeTransitionStart", (t, s, i) => {
            !e.destroyed &&
              e.autoplay.running &&
              (i || !e.params.autoplay.disableOnInteraction ? x(!0, !0) : T());
          }),
          s("sliderFirstMove", () => {
            !e.destroyed &&
              e.autoplay.running &&
          ...
          Object.assign(e.autoplay, { start: S, stop: T, pause: x, resume: E });
      },
    ]),
    new R(".mySwiperTeam", {
      slidesPerView: 5,
      ...
      breakpoints: {
        0: { slidesPerView: 3, slidesPerGroup: 1, loop: !0 },
        601: { slidesPerView: 4, slidesPerGroup: 1, loop: !0 },
        1201: { slidesPerView: 5, slidesPerGroup: 1, loop: !0 },
      },
    }),
    ...
    ymaps.ready(function () {
      var e = new ymaps.Map(
          "map",
          { center: [55.742093, 37.597414], zoom: 15 },
    ...
    (ymaps = window.ymaps);
  const U = document.querySelector(".menu_header"),
