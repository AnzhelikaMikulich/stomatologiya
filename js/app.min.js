(() => {
          ...
          void 0 !== a &&
            ...
            (o(t[i]) && o(r[i])
              ? r[i].__swiper__
                ...
                : d(t[i], r[i])
              : !o(t[i]) && o(r[i])
              ? ((t[i] = {}), r[i].__swiper__ ? (t[i] = r[i]) : d(t[i], r[i]))
              : (t[i] = r[i]));
        }
      }
    }
    ...
    M = {
      ...
      updateSlides: function () {
        ...
        const i = e.params,
          ...
          m = u(r, `.${e.params.slideClass}, swiper-slide`),
        ...
        for (let a = 0; a < h; a += 1) {
          ...
          if (
            ((k = 0),
            m[a] && (r = m[a]),
            P && e.grid.updateSlide(a, r, h, t),
            !m[a] || "none" !== f(r, "display"))
          ) {
            if ("auto" === i.slidesPerView) {
              ...
              (k = (n - (i.slidesPerView - 1) * x) / i.slidesPerView),
                i.roundLengths && (k = Math.floor(k)),
                m[a] && (m[a].style[t("width")] = `${k}px`);
            m[a] && (m[a].swiperSlideSize = k),
              b.push(k),
              i.centeredSlides
                ? ((C = C + k / 2 + M / 2 + x),
                  0 === M && 0 !== a && (C = C - n / 2 - x),
        ...
        if (
          ...
          P && e.grid.updateWrapperSize(k, g, t),
          !i.centeredSlides)
        ) {
          const t = [];
        ...
        if ((0 === g.length && (g = [0]), 0 !== i.spaceBetween)) {
          ...
          m.filter(
            (e, t) => !(i.cssMode && !i.loop) || t !== m.length - 1
          ).forEach((e) => {
            e.style[s] = `${x}px`;
          });
        }
        ...
        if (
          ...
          c(a, "--swiper-centered-offset-before", -g[0] + "px"),
            c(
              a,
      ...
      updateSlidesClasses: function () {
        const e = this,
          ...
          n = (e) => u(i, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
        let l;
        if (
          (t.forEach((e) => {
            e.classList.remove(
        ...
        (a = parseInt(
          ...
          t.centeredSlides
            ? r < e.loopedSlides - i / 2 ||
              ...
              ? (e.loopFix(),
                (r = e.getSlideIndex(
                  u(s, `${l}[data-swiper-slide-index="${a}"]`)[0]
                )),
                n(() => {
                  e.slideTo(r);
                }))
          ...
          a.currentTranslate > s.minTranslate() &&
            ...
            r.resistance &&
              (a.currentTranslate =
                s.minTranslate() -
                1 +
                (-s.minTranslate() + a.startTranslate + v) ** E)))
        : v < 0 &&
          (y &&
            !S &&
            a.currentTranslate <
          ...
          a.currentTranslate < s.maxTranslate() &&
            ...
            r.resistance &&
              (a.currentTranslate =
                s.maxTranslate() +
                1 -
                (s.maxTranslate() - a.startTranslate - v) ** E))),
  ...
  function I(e) {
    ...
    for (
      ...
      void 0 !== d[e + t]
        ? f >= d[e] && f < d[e + t] && ((h = e), (g = d[e + t] - d[e]))
        : f >= d[e] && ((h = e), (g = d[d.length - 1] - d[d.length - 2]));
    }
    let v = null,
      w = null;
    a.rewind &&
      ...
      events: {
        attachEvents: function () {
          ...
          (e.onTouchStart = k.bind(e)),
            ...
            (e.onClick = z.bind(e)),
            (e.onLoad = B.bind(e)),
            _ || (t.addEventListener("touchstart", D), (_ = !0)),
            $(e, "on");
        },
  ...
  class q {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = h(u(t, `.${s.slideClass}, swiper-slide`)[0]);
      return h(e) - i;
    }
    ...
    return (
      e.params.createElements &&
        Object.keys(i).forEach((a) => {
          if (!s[a] && !0 === s.auto) {
            let r = u(e.el, `.${i[a]}`)[0];
            r || ((r = m("div", i[a])), (r.className = i[a]), e.el.append(r)),
              (s[a] = r),
              (t[a] = r);
          }
        }),
  ...
  !(function (e) {
    ...
    R.use([
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: i }) {
        ...
        function c(t) {
          ...
          if (!s) return;
          t.preventDefault();
          const i = h(s) * e.params.slidesPerGroup;
          if (e.params.loop) {
        ...
        function p() {
          ...
          if (
            ...
            if (
              (s.dynamicBullets &&
                ((r = v(i[0], e.isHorizontal() ? "width" : "height", !0)),
                p.forEach((t) => {
          ...
          "string" == typeof t.el &&
            ...
            s &&
              ...
              (e.params.uniqueNavElements &&
                ...
                s.length > 1 &&
                  (s = s.filter((t) => g(t, ".swiper")[0] === e.el)[0])),
        ...
        s("changeDirection", () => {
          ...
          s("init", () => {
            !1 === e.params.pagination.enabled ? w() : (m(), u(), p());
          }),
          s("activeIndexChange", () => {
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: a, params: r }) {
        let n, l;
    ...
    new R(".mySwiperTeam", {
      ...
      slidesPerGroup: 1,
      modules: [X],
      navigation: { nextEl: ".next_team", prevEl: ".prev_team" },
      breakpoints: {
        0: {
          grabCursor: !0,
          slidesPerView: 3,
        ...
        601: { slidesPerView: 4, slidesPerGroup: 1, loop: !0, speed: 1e3 },
        1201: { slidesPerView: 5, slidesPerGroup: 1, loop: !0, speed: 1e3 },
      },
    }),
    new R(".mySwiperFeedback", {
      slidesPerView: 2,
      speed: 700,
      slidesPerGroup: 1,
      spaceBetween: 20,
      loop: !0,
      modules: [X],
      navigation: { nextEl: ".next_feedback", prevEl: ".prev_feedback" },
      breakpoints: {
        0: {
          slidesPerView: 1,
          speed: 700,
    ...
    ymaps.ready(function () {
      var e = new ymaps.Map(
          "map",
          { center: [55.740771, 37.598986], zoom: 15 },
        ...
        t =
          ...
          new ymaps.Placemark(
            [55.742093, 37.597414],
            { hintContent: "Центр персональной стоматологии" },
            {
              iconLayout: "default#image",
              iconImageHref: "./img/maps.png",
              iconImageSize: [113, 131],
            }
          ));
      e.geoObjects.add(t);
    }),
    (ymaps = window.ymaps);
  const U = document.querySelectorAll(".menu_header"),
    K = document.querySelector(".burger_menu"),
    J = document.querySelectorAll(".header_li a"),
    Q = document.querySelector(".menu_mess");
  let Z = document.querySelector("body");
  const ee = document.querySelector(".header .sotial_header"),
    te = document.querySelectorAll(".close_mess");
  console.log(te),
    U &&
      U.forEach((e) =>
        e.addEventListener("click", () => {
          U.forEach((e) => e.classList.toggle("active")),
    ...
    Q &&
      (Q.addEventListener("click", () => {
        Q.classList.toggle("active"), Z.classList.toggle("lock");
      }),
      te &&
        te.forEach((e) =>
          e.addEventListener("click", () => {
            Q.classList.contains("active") &&
              (Q.classList.remove("active"), Z.classList.remove("lock"));
          })
        ));
})();
